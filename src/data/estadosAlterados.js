...
export const ESTADOS_ALTERADOS = [
  ...
  { id: "HEMORRAGIA_I", texto: "hemorragia", reduce: "si", numReduce: 4, turno: "principio", daño: 1, max: 4, imagen: hemorragia },
  { id: "VENENO_I", texto: "veneno", reduce: "no", numReduce: 0, turno: "principio", daño: 1, max: 4, imagen: veneno },
  { id: "INTIMIDAR_I", texto: "intimidar", reduce: "si", numReduce: 4, turno: "final", daño: 0, max: 4, imagen: intimidar },
  { id: "QUEMADURA_I", texto: "quemadura", reduce: "si", numReduce: 1, turno: "principio", daño: 1, max: 4, imagen: quemadura },
  ...
  //{id: "KI", reduce:"", max: 4},
  { id: "ESCUDO", texto: "escudo", reduce: "no", numReduce: 0, turno: "", daño: 0, max: 4, imagen: escudo }
];
