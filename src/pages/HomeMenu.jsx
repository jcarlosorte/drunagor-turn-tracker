...
export default function HomeMenu() {
  ...
  return (
    <PageTransition>
      <div className="min-h-screen flex items-center justify-center bg-green-950/90">
        <div className="flex gap-6 p-6 rounded-lg shadow-lg border border-green-800 bg-green-900/80">
          <button
