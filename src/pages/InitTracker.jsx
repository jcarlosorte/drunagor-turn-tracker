...
const InitTracker = () => {
  ...
  const RuneCard = ({ rune, onRemove, flipped }) => {
    ...
    const renderSide = (caraB = false) => {
      ...
      return (
        <div className={`${posicion === 'abajo' ? 'absolute w-full h-full' : 'absolute bottom-0 left-0 right-0'} backface-hidden ${ caraB ? 'rotate-y-180' : '' }`} >
    ...
    return (
      <div className={`${rune.posicion === 'abajo' ? '' : ''} w-full perspective hover:scale-105`}>
