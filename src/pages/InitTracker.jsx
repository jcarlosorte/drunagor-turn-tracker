...
const InitTracker = () => {
  ...
  const renderSlot = (index) => {
    ...
    //const enemiesAbove = (placedEnemies.enemies || []).filter(e => runesColorMap[e.rune] === index && e.runePosition === 'arriba');
    //const enemiesBelow = (placedEnemies.enemies || []).filter(e => runesColorMap[e.rune] === index && e.runePosition === 'abajo');
    const enemiesAbove = (placedEnemies.enemies || []).filter(e => e.enemy.position === index && e.enemy.enemy.runePosition === 'arriba');
    const enemiesBelow = (placedEnemies.enemies || []).filter(e => e.enemy.position === index && e.enemy.enemy.runePosition === 'abajo');
