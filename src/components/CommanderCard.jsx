  ...
  return (
    <>
      <div
        ...
        className="cursor-pointer relative w-full max-w-[140px] items-center bg-black p-2 rounded-lg border-2 border-yellow-400 shadow-md hover:scale-105 transition"
      >
        <div
